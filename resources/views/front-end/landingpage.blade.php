...
@section('content')
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-xl-7 col-lg-6 icon-boxes d-flex flex-column align-items-stretch justify-content-center py-5 px-lg-5"
                    data-aos="fade-left">
                    <h3>Lorem, ipsum. ?</h3>
                    <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Ut adipisci doloremque quod. Eveniet voluptate ut dicta totam iusto, quis id libero mollitia? Officiis est fuga quibusdam neque aperiam dolore obcaecati voluptatibus perspiciatis.</p>
        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-sm-12 col-lg-7 text-center text-md-start" data-aos="fade-right'">
                    <img src="{{ asset('front-end/bootslander/img/service1.png') }}" class="img-fluid" alt="">
                </div>
            </div>
            <div class="row align-items-center">
                <div class="col-sm-12 col-lg-5 text-center text-lg-start">
                ...
                <div class="col-lg-4 aos-init aos-animate" data-aos="fade-right" data-aos-delay="100">
                    <div class="info">
                        <div class="address">
                            ...
                            <h4>Location:</h4>
                            <p>JL. Selamat Riyadi RT.015 Kel. Legok Kec. Danau Sipin Kota Jambi</p>
                        </div>
                        <div class="email">
                            <i class="icofont-envelope"></i>
                            <h4>Email:</h4>
                            <p><a href="mailto:maulana.yusup8989@gmail.com">Maulana.yusup8989@gmail.com</a></p>
                        </div>
                        <div class="phone">
                            <i class="icofont-linkedin"></i>
                            <h4>linkedin:</h4>
                            <p><a href="https://www.linkedin.com/in/maulanayusup701/" target="_blank" rel="noopener noreferrer">maulanayusup701</a></p>
                        </div>
                    </div>
                </div>
    ...
    <section id="contact" class="footer_wrapper" style="background:url('{{ asset('front-end/bootslander/img/hero_bg.png') }}') center top no-repeat; background-size: cover; background-color: var(--bg-black); color: var(--text-white);">
        <div class="container">
            <div class="row d-flex justify-content-between">
                <div class="col-lg-5 footer_logo mb-4 mb-lg-0">
                    <a href="/"><img src="{{ asset('front-end/bootslander/img/logo.png') }}" class="logo" alt="" width="150px"></a>
                    <p class="footer_text">Hashtag is a bright and results driven social media marketing drive customers, grow your audience and expand your reach.</p>
                </div>
                
                <div class="col-lg-3 mb-4 mb-lg-0">
                    <h3 class="footer_title">Social Media</h3>
                    <p>
                        <a href="https://www.instagram.com/maulana_yusup701/" target="_blank" class="footer_social_media_icon"><i class="fab fa-instagram"></i></a>
                        <a href="https://twitter.com/futaba701" target="_blank" class="footer_social_media_icon"><i class="fab fa-twitter"></i></a>
                        <a href="https://www.linkedin.com/in/maulanayusup701/" target="_blank" class="footer_social_media_icon"><i class="fab fa-linkedin"></i></a>
                    </p>
                </div>
